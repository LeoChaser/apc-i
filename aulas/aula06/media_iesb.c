...
int main() {
    ...
    if (9.0f <= media && media <= 10.0f) {
        printf("Sua media e %.1f e a mencao e SS!\n", media);
    } else if (7.0f <= media && media <= 8.9f) {
        printf("Sua media e %.1f e a mencao e MS!\n", media);
    } else if (5.0f <= media && media <= 6.9f) {
        printf("Sua media e %.1f e a mencao e MM!\n", media);
    } else if (3.0f <= media && media <= 4.9f) {
        printf("Sua media e %.1f e a mencao e MI!\n", media);
    } else if (0.1f <= media && media <= 2.9f) {
        printf("Sua media e %.1f e a mencao e II!\n", media);
    } else {
        printf("Sua media e %.1f e a mencao e SR!\n", media);
    }
