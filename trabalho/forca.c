...
#include <string.h> // para uso do strcmp
    ...
    while (menu_principal) {
        ...
        while (jogar) {
            ...
            if (menu_nome == 1) {
                ...
                menu_dificuldade = 1;
                if (vivo == 0 && menu_principal == 0 || menu_dificuldade == 0){
                    clrscr();
                    printf("====================================== FORCA ======================================\n");
            ...
            if (modo_desafio_ativo) {
                if (strcmp(mostrar_tema, "animais")) {
                    palavra = desafio_animais;
                    dica = dica_desafio_animais;
                } else if (strcmp(mostrar_tema, "caes")) {
            ...
            int tamanho_palavra = sizeof(palavra)/sizeof(palavra[0]);
            short int acertou = 0;
